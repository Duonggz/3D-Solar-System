...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/lanh2_1.jpg', label: 'Boreal Forest,Finland - View 1' },
    eiffel_2: { file: '../../textures1/lanh2_2.jpg', label: 'Boreal Forest,Finland - View 2' },
    eiffel_3: { file: '../../textures1/lanh2_3.jpg', label: 'Boreal Forest,Finland - View 3 (Video Area)' }
  };
