...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/lanh3_1.jpg', label: 'The Convention Centre Dublin - View 1' },
    eiffel_2: { file: '../../textures1/lanh3_2.jpg', label: 'Zamek Książ, Poland - View 2' },
    eiffel_3: { file: '../../textures1/lanh3_3.jpg', label: 'South Africa - View 3 (Video Area)' }
  };
