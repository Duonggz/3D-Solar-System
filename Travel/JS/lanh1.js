...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/lanh1_1.jpg', label: 'Hamburg - View 1' },
    eiffel_2: { file: '../../textures1/lanh1_2.jpg', label: 'Hamburg - View 2' },
    eiffel_3: { file: '../../textures1/lanh1_3.jpg', label: 'Hamburg - View 3 (Video Area)' }
  };
