...
import { OrbitControls } from '../../earth.OrbitControls.js';
...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/lanh5_1.jpg', label: 'Reichstag, Berlin, Germany - View 1' },
    eiffel_2: { file: '../../textures1/lanh5_2.jpg', label: 'Rotes Rathaus, Berlin, Germany - View 2' },
    eiffel_3: { file: '../../textures1/lanh5_3.jpg', label: 'Rotes Rathaus, Berlin, Germany - View 3 (Video Area)' }
  };
