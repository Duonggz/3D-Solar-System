...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/morning_1.jpg', label: 'German Town - View 1' },
    eiffel_2: { file: '../../textures1/morning_2.jpg', label: 'National Forum of Music - View 2' },
    eiffel_3: { file: '../../textures1/morning_3.jpg', label: 'Studio - View 3 (Video Area)' }
  };
