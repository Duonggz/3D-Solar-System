...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/lanh3_1.jpg', label: 'Kharkiv Historycal Museum, Ukranine - View 1' },
    eiffel_2: { file: '../../textures1/lanh3_2.jpg', label: 'Colosseeum, Rome - View 2' },
    eiffel_3: { file: '../../textures1/lanh3_3.jpg', label: 'Parlermo, Italia - View 3 (Video Area)' }
  };
