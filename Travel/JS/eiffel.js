...
function init() {
  ...
  const panoData = {
    eiffel_1: { file: '../../textures1/eiffel_1.jpg', label: 'Eiffel Tower - View 1' },
    eiffel_2: { file: '../../textures1/eiffel_2.jpg', label: 'Eiffel Tower - View 2' },
    eiffel_3: { file: '../../textures1/eiffel_3.jpg', label: 'Eiffel Tower - View 3 (Video Area)' }
  };
